...
(function (O, M) {
    ...
    M(J, "parts/Globals.js", [], function () {
        var c = "undefined" === typeof O ? "undefined" !== typeof window ? window : {} : O, p = c.document,
            y = c.navigator && c.navigator.userAgent || "", G = p && p.createElementNS && !!p.createElementNS("http://www.w3.org/2000/svg", "svg").createSVGRect, F = /(edge|msie|trident)/i.test(y) && !c.opera, z = -1 !== y.indexOf("Firefox"), r = -1 !== y.indexOf("Chrome"), K = z && 4 > parseInt(y.split("Firefox/")[1], 10);
        return {
            product: "Highcharts",
            version: "7.1.3",
    ...
    M(J, "parts/Utilities.js", [J["parts/Globals.js"]], function (c) {
        ...
        c.offset = function (b) {
            ...
            return {
                ...
                d.scrollTop) - (d.clientTop || 0), left: b.left + (l.pageXOffset || d.scrollLeft) - (d.clientLeft || 0)
            }
        };
        c.stop = function (b, d) {
    ...
    M(J, "parts/SvgRenderer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        E(L.prototype, {
            ...
            css: function (a) {
                var f = this.styles, I = {}, q = this.element, d = "", e = !f, k = ["textOutline", "textOverflow", "width"];
            ...
            updateTransform: function () {
                var a = this.translateX || 0, b = this.translateY || 0, f = this.scaleX, d = this.scaleY, e = this.inverted, k = this.rotation, g = this.matrix, c = this.element;
            ...
            getBBox: function (a, b) {
                var f, d = this.renderer, I = this.element, k = this.styles, g = this.textStr, c, h = d.cache, B = d.cacheKeys, P = I.namespaceURI === this.SVG_NS;
                b = q(b, this.rotation);
                var m = b * e;
            ...
            destroy: function () {
                var a =
                    this, b = a.element || {}, f = a.renderer, q = f.isSVG && "SPAN" === b.nodeName && a.parentGroup, d = b.ownerSVGElement, e = a.clipPath;
        ...
        E(p.prototype, {
            ...
            isHidden: function () {
                ...
                var f = a.element, d = this, e = d.forExport, k = q(a.textStr, "").toString(), c = -1 !== k.indexOf("<"), h = f.childNodes, B, I = b(f, "x"), m = a.styles, A = a.textWidth, C = m && m.lineHeight, L = m && m.textOutline, t = m && "ellipsis" === m.textOverflow, H = m && "nowrap" === m.whiteSpace, x = m && m.fontSize, n, l = h.length;
                ...
                var m = this, B = /^url\((.*?)\)$/, A = B.test(a), C = !A && (this.symbols[a] ? a : "circle"), I = C && this.symbols[C], N = y(b) && I && I.call(this.symbols, Math.round(b), Math.round(f), e, k, c);
                if (I) {
                    var L = this.path(N);
                ...
                var m = this, A = m.styledMode, C = m.g("button" !==
                    h && "label"), N = C.text = m.text("", 0, 0, g).attr({zIndex: 1}), t, H, u = 0, x = 3, n = 0, I, l, T, P, w, Q = {}, R, r, S = /^url\((.*?)\)$/.test(d), v = A || S, p = function () {
    ...
    M(J, "parts/Html.js",
        [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
            var y = p.defined, G = p.pInt, F = c.attr, z = c.createElement, r = c.css, K = c.extend, v = c.isFirefox, D = c.isMS, w = c.isWebKit, n = c.pick, l = c.SVGElement;
            p = c.SVGRenderer;
            var b = c.win;
            K(l.prototype, {
                htmlCss: function (b) {
                    ...
                    if (this.added) {
                        var b = this.renderer, a = this.element, g = this.translateX || 0, c = this.translateY || 0, e = this.x || 0, m = this.y || 0, u = this.textAlign || "left", n = {
                            left: 0,
                            center: .5,
                            right: 1
                        }[u], t = this.styles, x = t && t.whiteSpace;
                        ...
                        if ("SPAN" === a.tagName) {
                            t = this.rotation;
                            var k = this.textWidth && G(this.textWidth), A = [t, u, a.innerHTML, this.textWidth, this.textAlign].join(), B;
            ...
            K(p.prototype, {
                getTransformKey: function () {
                    ...
                    var d = this.createElement("span"), e = d.element, m = d.renderer, u = m.isSVG, E = function (a, b) {
    ...
    M(J, "parts/Time.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isObject, F = p.objectEach, z = p.splat, r = c.extend, K = c.merge, v = c.pick, D = c.timeUnits, w = c.win;
        c.Time = function (c) {
            this.update(c, !1)
        };
        c.Time.prototype = {
            defaultOptions: {}, update: function (c) {
                ...
                var d = this, a = new this.Date(l), g = this.get("Hours",
                    a), h = this.get("Day", a), e = this.get("Date", a), m = this.get("Month", a), u = this.get("FullYear", a), E = c.defaultOptions.lang, t = E.weekdays, x = E.shortWeekdays, k = c.pad;
                a = c.extend({
    ...
    M(J, "parts/Tick.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.correctFloat, z = c.destroyObjectProperties, r = c.fireEvent, K = c.merge, v = c.pick, D = c.deg2rad;
        ...
        c.Tick.prototype = {
            addLabel: function () {
                var w = this, n = w.axis, l =
                    n.options, b = n.chart, d = n.categories, a = n.names, g = w.pos, h = v(w.options && w.options.labels, l.labels), e = n.tickPositions, m = g === e[0], u = g === e[e.length - 1];
                ...
                var n = this.axis, l = n.options.labels, b = c.x, d = n.chart.chartWidth, a = n.chart.spacing, g = v(n.labelLeft, Math.min(n.pos, a[3]));
                a = v(n.labelRight, Math.max(n.isRadial ? 0 : n.pos + n.len, d - a[1]));
                var h = this.label, e = this.rotation, m = {
                        left: 0,
                        center: .5,
                        right: 1
                    }[n.labelAlign || h.attr("align")], u = h.getBBox().width,
            ...
            getPosition: function (w, n, l, b) {
                ...
                var e = this.axis, m = e.transA, u = e.reversed,
                    E = e.staggerLines, t = e.tickRotCorr || {
                            x: 0,
                            y: 0
                        }, x = d.y, k = b || e.reserveSpaceDefault ? 0 : -e.labelOffset * ("center" === e.labelAlign ? .5 : 1), A = {};
                ...
                var b = this.axis, d = b.options, a = this.gridLine, g = {}, h = this.pos, e = this.type, m = v(this.tickmarkOffset, b.tickmarkOffset), u = b.chart.renderer, E = e ? e + "Grid" : "grid", t = d[E + "LineWidth"], x = d[E + "LineColor"];
                d = d[E + "LineDashStyle"];
                ...
                var b = this.axis, d = b.options, a = b.chart.renderer, g = this.type, h = g ? g + "Tick" : "tick", e = b.tickSize(h), m = this.mark, u = !m, E = c.x;
                c = c.y;
            ...
            c.extend(p.prototype,
                {
                    ...
                    defaultLabelFormatter: function () {
                        var a = this.axis, b = this.value, e = a.chart.time, k = a.categories, g = this.dateTimeLabelFormat, h = d.lang, B = h.numericSymbols;
                    ...
                    getPlotLinePath: function (a) {
                        var b = this, q = b.chart, d = b.left, c = b.top, k = a.old, g = a.value, h = a.translatedValue, m = a.lineWidth, B = a.force, A, t, u, H, n = k && q.oldChartHeight || q.chartHeight, l = k && q.oldChartWidth || q.chartWidth, E, r = b.transB, w = function (a, b, f) {
                    ...
                    getMinorTickPositions: function () {
                        var a = this, b = a.options, d = a.tickPositions, e = a.minorTickInterval, c = [], k = a.pointRangePadding || 0, g = a.min - k;
                        k = a.max + k;
                        var h = k - g;
                    ...
                    setAxisTranslation: function (a) {
                        var b = this, d = b.max - b.min, q = b.axisPointRange || 0, c = 0, k = 0, g = b.linkedParent, h = !!b.categories, m = b.transA, B = b.isXAxis;
                        if (B || h || q) {
                            var t = b.getClosest();
                            g ? (c = g.minPointOffset, k = g.pointRangePadding) : b.series.forEach(function (a) {
                                var f =
                                    h ? 1 : B ? x(a.options.pointRange, t, 0) : b.axisPointRange || 0, d = a.options.pointPlacement;
                                q = Math.max(q, f);
                    ...
                    setTickInterval: function (a) {
                        var f = this, d = f.chart, q = f.options, k = f.isLog, g = f.isDatetimeAxis, h = f.isXAxis, m = f.isLinked, B = q.maxPadding, A = q.minPadding, H = q.tickInterval, n = q.tickPixelInterval, l = f.categories, E = F(f.threshold) ? f.threshold : null, r = f.softThreshold;
                    ...
                    adjustTickAmount: function () {
                        var a = this.options, d = this.tickInterval, e = this.tickPositions, c = this.tickAmount, k = this.finalTickAmt, g = e && e.length, h = x(this.threshold, this.softThreshold ? 0 : null), m;
                        if (this.hasData()) {
                            if (g < c) {
                    ...
                    zoom: function (a, b) {
                        var d = this.dataMin, f = this.dataMax, c = this.options, q = Math.min(d, x(c.min, d)), k = Math.max(f, x(c.max, f));
                        a = {newMin: a, newMax: b};
                    ...
                    tickSize: function (a) {
                        var b = this.options, d = b[a + "Length"], c = x(b[a + "Width"], "tick" === a && this.isXAxis && !this.categories ? 1 : 0);
                        if (c && d) {
                    ...
                    unsquish: function () {
                        var d = this.options.labels, f = this.horiz, e = this.tickInterval, c = e, k = this.len / (((this.categories ? 1 : 0) + this.max - this.min) / e), g, h = d.rotation, m = this.labelMetrics(), B, A = Number.MAX_VALUE, t, u = this.max - this.min, H = function (a) {
                            var d = a / (k || 1);
                            d = 1 < d ? Math.ceil(d) : 1;
                    ...
                    getSlotWidth: function (a) {
                        var b = this.chart, d = this.horiz, e = this.options.labels, c = Math.max(this.tickPositions.length - (this.categories ? 0 : 1), 1), k = b.margin[3];
                    ...
                    renderUnsquish: function () {
                        var a = this.chart, b = a.renderer, d = this.tickPositions, e = this.ticks, c = this.options.labels, k = c && c.style || {}, g = this.horiz, h = this.getSlotWidth(), m = Math.max(1, Math.round(h - 2 * (c.padding || 5))), B = {}, A = this.labelMetrics(), t = c.style && c.style.textOverflow, u = 0;
                    ...
                    addTitle: function (a) {
                        var b = this.chart.renderer, d = this.horiz, e = this.opposite, c = this.options.title, k, g = this.chart.styledMode;
                    ...
                    getOffset: function () {
                        var a = this, b = a.chart, d = b.renderer, c = a.options, k = a.tickPositions, g = a.ticks, h = a.horiz, m = a.side, B = b.inverted && !a.isZAxis ? [1, 0, 3, 2][m] : m, A, t = 0, u = 0, H = c.title, n = c.labels, l = 0, E = b.axisOffset;
                        b = b.clipOffset;
                    ...
                    getLinePath: function (a) {
                        var b = this.chart, d = this.opposite, e = this.offset, c = this.horiz, k = this.left + (d ? this.width : 0) + e;
                    ...
                    getTitlePosition: function () {
                        var a = this.horiz, b = this.left, d = this.top, c = this.len, k = this.options.title, g = a ? b : d, h = this.opposite, m = this.offset, B = k.x || 0, A = k.y || 0, t = this.axisTitle, u = this.chart.renderer.fontMetrics(k.style && k.style.fontSize, t);
                    ...
                    render: function () {
                        var a = this, b = a.chart, d = a.options, k = a.isLog, g = a.isLinked, h = a.tickPositions, m = a.axisTitle, A = a.ticks, t = a.minorTicks, u = a.alternateBands, n = d.stackLabels, x = d.alternateGridColor, l = a.tickmarkOffset, E = a.axisLine, w = a.showAxis, z = D(b.renderer.globalAnimation), v, p;
    ...
    M(J, "parts/PlotLineOrBand.js", [J["parts/Globals.js"], J["parts/Axis.js"], J["parts/Utilities.js"]], function (c, p, y) {
        var G = y.defined, F = y.erase, z = y.objectEach, r = c.arrayMax, K = c.arrayMin, v = c.destroyObjectProperties, D = c.merge, w = c.pick;
        ...
        c.PlotLineOrBand.prototype =
        {
            render: function () {
                ...
                var n = this, l = n.axis, b = l.horiz, d = n.options, a = d.label, g = n.label, h = d.to, e = d.from, m = d.value, u = G(e) && G(h), E = G(m), t = n.svgElem, x = !t, k = [], A = d.color, B = w(d.zIndex, 0), H = d.events;
    ...
    M(J, "parts/Tooltip.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        c.Tooltip.prototype = {
            init: function (b, d) {
                ...
                var b = this, d = this.chart.renderer, a = this.chart.styledMode, g = this.options, h = "tooltip" + (y(g.className) ? " " + g.className : ""), e;
                if (!this.label) {
                ...
                var h = this, e = h.now, m = !1 !== h.options.animation && !h.isHidden && (1 < Math.abs(b - e.x) || 1 < Math.abs(d - e.y)), u = h.followPointer || 1 < h.len;
                K(e, {
                    x: m ? (2 * e.x + b) / 3 : b,
                    y: m ? (e.y + d) / 2 : d,
                ...
                var c = this.chart, h = this.distance, e = {}, m = c.inverted && a.h || 0, u, l = this.outside, t = l ? r.documentElement.clientWidth -
                2 * h : c.chartWidth, x = l ? Math.max(r.body.scrollHeight, r.documentElement.scrollHeight, r.body.offsetHeight, r.documentElement.offsetHeight, r.documentElement.clientHeight) : c.chartHeight, k = c.pointer.chartPosition, A = c.containerScaling, B = function (a) {
                ...
                }, f = q("y"), n = q("x"), N = !this.followPointer && w(a.ttBelow, !c.inverted === !!a.negative), v = function (a, b, d, c, f, k, g) {
                    var q = "y" === a ? H(h) : B(h), A = (d - c) / 2, t = c < f - h, u = f + h + c < b, x = f - q - d + A;
                    f = f + q - A;
                ...
                b.slice(0, d.length + 1).forEach(function (b, c) {
                    if (!1 !== b && "" !== b) {
                        ...
                        var B = c.series || a, q = B.tt, f = c.series || {}, A = "highcharts-color-" + w(c.colorIndex, f.colorIndex, "none");
                        q || (q = {
                            padding: u.padding,
                            r: u.borderRadius
                ...
                var d = this.chart, a = this.getLabel(), g = (this.options.positioner || this.getPosition).call(this, a.width, a.height, b), h = b.plotX + d.plotLeft;
                b = b.plotY + d.plotTop;
                if (this.outside) {
                ...
                var g = this.chart.time, e = g.dateFormat("%m-%d %H:%M:%S.%L", d), m = {
                    millisecond: 15,
                    second: 12,
                    minute: 9,
                    hour: 6,
                ...
                var a = d ? "footer" : "header", g = b.series, h = g.tooltipOptions, e = h.xDateFormat, m = g.xAxis, u = m && "datetime" === m.options.type && G(b.key), l = h[a + "Format"];
    ...
    M(J, "parts/Pointer.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = p.isObject, z = p.objectEach, r = p.splat, K = c.addEvent, v = c.attr, D = c.charts, w = c.color, n = c.css, l = c.extend, b = c.find, d = c.fireEvent, a = c.offset, g = c.pick, h = c.Tooltip;
        ...
        c.Pointer.prototype = {
            init: function (a, b) {
                ...
                a.forEach(function (a) {
                    ...
                    if ((e = F(a, !0)) && !(e = !F(c, !0))) {
                        e = c.distX - a.distX;
                        var k = c.dist - a.dist, g = (a.series.group && a.series.group.zIndex) - (c.series.group && c.series.group.zIndex);
                ...
                if (c && d)return b ? {chartX: c.len + c.pos - e, chartY: d.len + d.pos - a.plotY} : {
                    chartX: e + c.pos,
                ...
                var d = this.chart, e = d.tooltip && d.tooltip.options.enabled ? d.tooltip : void 0, h = e ? e.shared : !1, m = b || d.hoverPoint, k = m && m.series || d.hoverSeries;
                ...
                var d = this.chart, c = d.hoverSeries, e = d.hoverPoint, g = d.hoverPoints, k = d.tooltip, h = k && k.shared ? g : e;
                ...
                var b = this.chart, d = b.options.chart, c = a.chartX, e = a.chartY, g = this.zoomHor, k = this.zoomVert, h = b.plotLeft, B = b.plotTop, H = b.plotWidth, q = b.plotHeight, f = this.selectionMarker, l = this.mouseDownX, n = this.mouseDownY, r = d.panKey && a[d.panKey + "Key"];
                ...
                if (this.selectionMarker) {
                    var g = {originalEvent: a, xAxis: [], yAxis: []},
                        h = this.selectionMarker, k = h.attr ? h.attr("x") : h.x, A = h.attr ? h.attr("y") : h.y, B = h.attr ? h.attr("width") : h.width, H = h.attr ? h.attr("height") : h.height, q;
                    if (this.hasDragged || e)c.axes.forEach(function (d) {
                        if (d.zoomEnabled && y(d.min) && (e || b[{xAxis: "zoomX", yAxis: "zoomY"}[d.coll]])) {
                            var c = d.horiz, f = "touchend" === a.type ? d.minPixelPadding : 0, h = d.toValue((c ? k : A) + f);
        ...
        y(c.Pointer.prototype,
            {
                ...
                var b = this.chart, d = c ? "x" : "y", a = c ? "X" : "Y", g = "chart" + a, h = c ? "width" : "height", e = b["plot" + (c ? "Left" : "Top")], m, u, E = l || 1, t = b.inverted, x = b.bounds[c ? "h" : "v"], k = 1 === r.length, A = r[0][g], B = p[0][g], H = !k && r[1][g], q = !k && p[1][g];
                p = function () {
                ...
                var r = this, p = r.chart, v = r.pinchDown, z = c.touches, w = z.length, n = r.lastValidTouch, l = r.hasZoom, b = r.selectionMarker, d = {}, a = 1 === w && (r.inClass(c.target, "highcharts-tracker") && p.runTrackerClick || r.runChartClick), g = {};
                1 < w && (r.initiated = !0);
                ...
                "touchstart" === c.type ? ([].forEach.call(z, function (a, b) {
                    ...
                    if (a.zoomEnabled) {
                        var b = p.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, c = a.toPixels(Math.min(F(a.options.min, a.dataMin), a.dataMin)), g = a.toPixels(Math.max(F(a.options.max, a.dataMax), a.dataMax)), h = Math.max(c,
                            g);
    ...
    M(J, "parts/Legend.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        c.Legend.prototype = {
            init: function (a, b) {
                ...
                if (!this.chart.styledMode) {
                    var d = this.options, c = a.legendItem, g = a.legendLine, l = a.legendSymbol, n = this.itemHiddenStyle.color;
                ...
                var a = this.group && this.group.alignAttr, b = this.clipHeight || this.legendHeight, d = this.titleHeight;
                if (a) {
                    var c = a.translateY;
                ...
                var b = this.chart,
                    d = b.renderer, c = this.options, m = this.symbolWidth, l = c.symbolPadding, n = this.itemStyle, t = this.itemHiddenStyle, x = "horizontal" === c.layout ? w(c.itemDistance, 20) : 0, k = !c.rtl, A = a.legendItem, B = !a.series, H = !B && a.series.drawLegendSymbol ? a.series : a, q = H.options;
                ...
                var b = this.options, d = this.padding, c = "horizontal" === b.layout, m = a.itemHeight,
                    l = b.itemMarginBottom || 0, n = this.itemMarginTop, t = c ? w(b.itemDistance, 20) : 0, x = this.maxLegendWidth;
                ...
                var d =
                    this.chart, c = this.options, g = this.getAlignment(), l = d.options.title.margin, n = void 0 !== l ? d.titleOffset[0] + l : 0, t = void 0 !== l ? d.titleOffset[2] + l : 0;
                ...
                var t = m.maxHeight, x, k = this.clipRect, A = m.navigation, B = w(A.animation, !0), H = A.arrowSize || 12, q = this.nav, f = this.pages, C, r = this.allItems,
                    p = function (a) {
        ...
        c.LegendSymbolMixin = {
            drawRectangle: function (a, b) {
                ...
                var b = this.options, d = b.marker, c = a.symbolWidth, m = a.symbolHeight, l = m / 2, n = this.chart.renderer, t = this.legendGroup;
        ...
        function (c, p) {
            ...
            t(S.prototype, {
                callbacks: [], getArgs: function () {
                    ...
                    k(this, "beforeRedraw");
                    var b = this.axes, d = this.series, f = this.pointer, e = this.legend, g = this.userOptions.legend, h = this.isDirtyLegend, q = this.hasCartesianSeries,
                    ...
                    var d = this, f = d.options.chart, k = d.renderTo, e = y(f.width) && y(f.height), g = f.width || c.getStyle(k, "width");
                    ...
                    var b = this.inverted, d = this.renderer, c = this.chartWidth, f = this.chartHeight, e = this.options.chart, g = this.spacing, h = this.clipOffset, q, B, A, m;
                    ...
                    var a = this.options.chart, b = this.renderer, d = this.chartWidth, c = this.chartHeight, f = this.chartBackground,
                        e = this.plotBackground, g = this.plotBorder, h = this.styledMode, q = this.plotBGImage, B = a.backgroundColor, A = a.plotBackgroundColor, m = a.plotBackgroundImage, l, t = this.plotLeft, n = this.plotTop, H = this.plotWidth, x = this.plotHeight, C = this.plotBox, u = this.clipRect, w = this.clipBox, r = "animate";
    ...
    M(J, "parts/ScrollablePlotArea.js", [J["parts/Globals.js"]],
        function (c) {
            ...
            y.prototype.moveFixedElements = function () {
                var c = this.container, p = this.fixedRenderer, z = ".highcharts-contextbutton .highcharts-credits .highcharts-legend .highcharts-reset-zoom .highcharts-subtitle .highcharts-title .highcharts-legend-checkbox".split(" "), r;
            ...
            y.prototype.applyFixed = function () {
                ...
                var K = this.plotLeft + this.plotWidth - (this.scrollablePixelsX || 0), v = this.plotTop + this.plotHeight - (this.scrollablePixelsY || 0);
    ...
    M(J, "parts/Point.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isObject, K, v = c.extend, D = c.fireEvent, w = c.format, n = c.pick, l = c.uniqueKey, b = c.removeEvent;
        c.Point = K = function () {
        };
        c.Point.prototype = {
            init: function (b, a, c) {
                ...
                var a = {}, d = this.series, h = d.options.keys, e = h || d.pointArrayMap || ["y"], m = e.length, l = 0, n = 0;
                ...
                var a = this.series, d = a.tooltipOptions, c = n(d.valueDecimals, ""), e = d.valuePrefix || "", m = d.valueSuffix || "";
    ...
    M(J, "parts/Series.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.erase, F = p.isArray, z = p.isNumber, r = p.isString,
            K = p.objectEach, v = p.splat, D = c.addEvent, w = c.animObject, n = c.arrayMax, l = c.arrayMin, b = c.correctFloat, d = c.defaultOptions, a = c.defaultPlotOptions, g = c.extend, h = c.fireEvent, e = c.merge, m = c.pick, u = c.removeEvent, E = c.SVGElement, t = c.syncTimeout, x = c.win;
        c.Series = c.seriesType("line", null, {
            ...
            getCyclic: function (a, b, d) {
                var c = this.chart, e = this.userOptions, f = a + "Index", k = a + "Counter", g = d ? d.length : m(c.options.chart[a + "Count"], c[a + "Count"]);
                if (!b) {
                    var h = m(e[f], e["_" + f]);
            ...
            setData: function (a, b, d, e) {
                var k = this, f = k.points, g = f && f.length || 0, h, A = k.options, l = k.chart, B = null, n = k.xAxis, t = A.turboThreshold, H = this.xData, x = this.yData, u = (h = k.pointArrayMap) && h.length, w = A.keys, p = 0, v = 1, E;
                a = a || [];
                h = a.length;
                b = m(b, !0);
            ...
            generatePoints: function () {
                var a = this.options, b = a.data, d = this.data, c, e = this.processedXData, f = this.processedYData, m = this.pointClass,
            ...
            translate: function () {
                ...
                this.generatePoints();
                var a = this.options, d = a.stacking, c = this.xAxis, e = c.categories, g = this.yAxis, f = this.points, l = f.length, t = !!this.modifyValue, n, x = this.pointPlacementToXValue(), u = z(x), p = a.threshold, w = a.startFromThreshold ?
            ...
            setClip: function (a) {
                var b = this.chart, d = this.options, c = b.renderer, e = b.inverted, f = this.clipBox, k = this.getClipBox(a), g = this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, k.height, d.xAxis, d.yAxis].join(), h = b[g], m = b[g + "m"];
            ...
            drawPoints: function () {
                var a = this.points, b = this.chart, d, c = this.options.marker, e = this[this.specialGroup] || this.markerGroup;
                var f = this.xAxis;
            ...
            drawGraph: function () {
                var a = this, b = this.options, d = (this.gappedPath || this.getGraphPath).call(this), c = this.chart.styledMode, e = [["graph", "highcharts-graph"]];
            ...
            applyZones: function () {
                var a = this, b = this.chart, d = b.renderer, c = this.zones, e, f, g = this.clips || [], h, l = this.graph, t = this.area, n = Math.max(b.chartWidth, b.chartHeight), x = this[(this.zoneAxis || "y") + "Axis"], u = b.inverted, p, w, r, v = !1;
            ...
            render: function () {
                var a = this, b = a.chart, d = a.options, c = !!a.animate && b.renderer.isSVG && w(d.animation).duration, e = a.visible ? "inherit" : "hidden", f = d.zIndex, g = a.hasRendered, m = b.seriesGroup, l = b.inverted;
                h(this, "render");
    ...
    M(J, "parts/Stacking.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        c.StackItem.prototype = {
            destroy: function () {
                ...
                if (n && d) {
                    var g = n.getBBox(), h = a.inverted ? c ? g.width : 0 : g.width / 2, e = a.inverted ? g.height / 2 : c ? -4 : g.height + 4;
        ...
        D.prototype.setStackedPoints = function () {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                var p = this.processedXData, n = this.processedYData, l = [], b = n.length, d = this.options, a = d.threshold, g = v(d.startFromThreshold && a, 0), h = d.stack;
                d = d.stacking;
                var e = this.stackKey, m = "-" + e, u = this.negStacks, r = this.yAxis, t = r.stacks, x = r.oldStacks, k, A;
                r.stacksTouched += 1;
                for (A = 0; A < b; A++) {
                    var B = p[A];
                    var H = n[A];
    ...
    M(J, "parts/Dynamics.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        p = c.Chart;
        var b = c.createElement, d = c.css, a = c.extend, g = c.fireEvent, h = c.merge, e = c.pick, m = c.Point, u = c.Series, E = c.seriesTypes, t = c.setAnimation;
        ...
        a(p.prototype, {
            ...
            update: function (a, b, d, m) {
                ...
                }, f, n, t, x = a.isResponsiveOptions, A = [];
        ...
        a(u.prototype, {
            addPoint: function (a, b, d, c, h) {
                ...
                var k = this, m = k.chart, l = k.userOptions, n = k.initialType || k.type, f = b.type || l.type || m.options.chart.type, t = !(this.hasDerivedData ||
                b.dataGrouping || f && f !== this.type || void 0 !== b.pointStart || b.pointInterval || b.pointIntervalUnit || b.keys), u = E[n].prototype, x, p = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"], r = ["eventOptions", "navigatorSeries", "baseSeries"], v = k.finishedAnimating && {animation: !1}, w = {};
        ...
        p("area", "line",
            {softThreshold: !1, threshold: 0}, {
                singleStacks: !1, getStackPoints: function (c) {
                    var p = [], r = [], z = this.xAxis, w = this.yAxis, n = w.stacks[this.stackKey], l = {}, b = this.index, d = w.series, a = d.length, g = F(w.options.reversedStacks, !0) ? 1 : -1, h;
                    c = c || this.points;
                    ...
                    var r = z.prototype.getGraphPath, v = this.options, y = v.stacking,
                        w = this.yAxis, n, l = [], b = [], d = this.index, a = w.stacks[this.stackKey], g = v.threshold, h = Math.round(w.getThreshold(v.threshold));
    ...
    M(J, "parts/ColumnSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isNumber, F = c.animObject, z = c.color, r = c.extend, K = c.merge, v = c.pick, D = c.Series;
        p = c.seriesType;
        var w = c.svg;
        p("column", "line", {
            borderRadius: 0,
            ...
            translate: function () {
                ...
                var a = c.yAxis, g = b.threshold, h = c.translatedThreshold = a.getThreshold(g), e = v(b.minPointLength, 5), m = c.getColumnMetrics(), p = m.width, r = c.barW = Math.max(p, 1 + 2 * d), t = c.pointXOffset = m.offset, x = c.dataMin, k = c.dataMax;
                l.inverted && (h -= .5);
            ...
            pointAttribs: function (c, l) {
                ...
                var g = d["stroke-width"] || "borderWidth", h = c && c.color || this.color, e = c && c[a] || b[a] || this.color || h, m = c && c[g] || b[g] || this[g] || 0;
                d = c &&
            ...
            animate: function (c) {
                var l = this, b = this.yAxis, d = l.options, a = this.chart.inverted, g = {}, h = a ? "translateX" : "translateY";
    ...
    M(J, "parts/PieSeries.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        var z = p.getStartAndEndRadians, r = c.merge, K = c.noop, v = c.pick, D = c.Point, w = c.Series, n = c.seriesType, l = c.setAnimation;
        n("pie", "line", {
            center: [null, null],
            clip: !1,
            colorByPoint: !0,
            ...
            translate: function (b) {
                this.generatePoints();
                var d = 0, a = this.options, g = a.slicedOffset, h = g + (a.borderWidth || 0), e = z(a.startAngle, a.endAngle), m = this.startAngleRad = e.start;
            ...
            init: function () {
                ...
                var b =
                    this.labelPosition, c = this.series.options.dataLabels, a = c.connectorShape, g = this.connectorShapes;
                g[a] && (a = g[a]);
    ...
    M(J, "parts/DataLabels.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        var y = p.defined, G = p.isArray, F = p.objectEach, z = p.splat, r = c.arrayMax, K = c.extend, v = c.format, D = c.merge;
        p = c.noop;
        ...
        l.prototype.drawDataLabels = function () {
            ...
            var d = this, e = d.chart, l = d.options, n = l.dataLabels,
                p = d.points, t, r = d.hasRendered || 0, k = c.animObject(l.animation).duration, A = Math.min(k, 200), B = !e.renderer.forExport && w(n.defer, 0 < A), H = e.renderer;
            ...
            if (G(n) || n.enabled || d._hasPointLabels) {
                ...
                p.forEach(function (c) {
                    ...
                    t.forEach(function (b, f) {
                        var g = b.enabled && (!c.isNull || c.dataLabelOnNull) && a(c, b), k = c.dataLabels ? c.dataLabels[f] : c.dataLabel, h = c.connectors ? c.connectors[f] : c.connector, m = w(b.distance, c.labelDistance), t = !k;
                        if (g) {
        ...
        l.prototype.alignDataLabel = function (a, b, c, d, l) {
            var e = this.chart, g = this.isCartesian && e.inverted, h = w(a.dlBox &&
                a.dlBox.centerX, a.plotX, -9999), m = w(a.plotY, -9999), k = b.getBBox(), n = c.rotation, p = c.align, r = this.visible && (a.series.forceDL || e.isInsidePlot(h, Math.round(m), g) || d && e.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g)), q = "justify" === w(c.overflow, "justify");
            if (r) {
        ...
        b.pie && (b.pie.prototype.dataLabelPositioners = {
            ...
            var a = this, b = a.data, d, e = a.chart, m = a.options.dataLabels, n = m.connectorPadding, p, t = e.plotWidth, x = e.plotHeight, k = e.plotLeft, A = Math.round(e.chartWidth / 3), v, z = a.center, q = z[2] / 2, f = z[1], C, F, K, G, J = [[], []], L, I, M, Q, O = [0, 0, 0, 0], U = a.dataLabelPositioners, W;
        ...
        b.column && (b.column.prototype.alignDataLabel = function (a, b, c, d, m) {
            var e = this.chart.inverted, g = a.series, h = a.dlBox || a.shapeArgs,
                n = w(a.below, a.plotY > w(this.translatedThreshold, g.yAxis.len)), k = w(c.inside, !!this.options.stacking);
    ...
    M(J, "parts/Interaction.js", [J["parts/Globals.js"], J["parts/Utilities.js"]], function (c, p) {
        ...
        p = c.Chart;
        var K = c.createElement, v = c.css, D = c.defaultOptions, w = c.defaultPlotOptions, n = c.extend, l = c.fireEvent, b = c.hasTouch, d = c.Legend, a = c.merge, g = c.pick, h = c.Point, e = c.Series, m = c.seriesTypes, u = c.svg;
        var E = c.TrackerMixin = {
            drawTrackerPoint: function () {
                ...
                var a = this, c = a.options, d = c.trackByArea, e = [].concat(d ? a.areaPath : a.graphPath), g = e.length, h = a.chart, m = h.pointer, f = h.renderer, n = h.options.tooltip.snap, p = a.tracker, r, w = function () {
        ...
        n(d.prototype, {
            setItemEvents: function (b, c, d) {
                var e = this, g = e.chart.renderer.boxWrapper, k = b instanceof h, m = "highcharts-legend-" + (k ? "point" : "series") + "-active", f = e.chart.styledMode;
        ...
        n(p.prototype, {
            showResetZoom: function () {
                ...
                var b = this, c = D.lang, d = b.options.chart.resetZoomButton, e = d.theme, g = e.states, h = "chart" === d.relativeTo ||
                ...
                !a || a.resetSelection ? (b.axes.forEach(function (a) {
                    ...
                    var f = a.axis, g = b.inverted ? f.left : f.top, k = b.inverted ? g + f.width : g + f.height, l = f.isXAxis, m = !1;
                ...
                l(this, "pan", {originalEvent: a},
                    function () {
                        ...
                        ("xy" === b ? [1, 0] : [1]).forEach(function (b) {
                            ...
                            var g = c[d], k = (b.pointRange || 0) / 2, h = b.reversed && !c.inverted || !b.reversed && c.inverted ? -1 : 1, l = b.getExtremes(), m = b.toValue(g - f, !0) + k * h;
        ...
        n(h.prototype, {
            select: function (a, b) {
                ...
                var c = this.series, d = this.state, e = c.options.states[a || "normal"] || {}, h = w[c.type].marker && c.options.marker, m = h && !1 === h.enabled, f = h && h.states && h.states[a || "normal"] || {}, p = !1 === f.enabled, r = c.stateMarkerGraphic,
        ...
        n(e.prototype, {
            onMouseOver: function () {
                ...
                var c = this, d = c.options, e = c.graph, h = d.inactiveOtherPoints, l = d.states, f = d.lineWidth, m = d.opacity, n = g(l[a || "normal"] && l[a || "normal"].animation, c.chart.options.chart.animation);
                d = 0;
                a = a || "";
